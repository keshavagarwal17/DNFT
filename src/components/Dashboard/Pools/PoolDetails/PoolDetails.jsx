...
//   new ethers.Contract("0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512", FakeItTokenContractArtifact.abi, ethProvider.getSigner(0))
  const getPoolOwners = async () => {
    try {
        ...
        let cont = await GetContract(addresses.fundsManager, FundsManagerArtifactContract.abi);
        setContract(cont);
        ...
        let poolContract = await GetContract(addresses.ownerShipToken, OwnerShipTokenArtifact.abi)
        ...
        let fakeItTokenContract = await GetContract(poolData.collectionAddress, FakeItTokenContractArtifact.abi)
