...
//   }
  ...
  const getAllNFTs = async () => {
    try {
        setLoadStatus(true);
        let allTokens = [];
        let fakeItTokenContract = await GetContract(addresses.fakeItToken, FakeItTokenContractArtifact.abi);
        let MarketPlaceContract = await GetContract(addresses.marketPlaceAddress, MarketPlaceContractArtifact.abi);
